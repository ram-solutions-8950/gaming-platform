...
export function AdminDashboardPage() {
  ...
  const handleRefresh = () => runRefresh(fetchDashboardData);
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Everything below the header reloads together, so the refresh state
          covers the whole panel until the new figures are in (BUG-004). */}
      <div className="relative space-y-8">
        <RefreshOverlay active={refreshing} label="Refreshing dashboard…" />
